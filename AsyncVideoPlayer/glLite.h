...
#define CR_GL_FUNC_LIST \
	...
	GLE(void,					glFlushMappedBufferRange,   GLenum target, GLintptr offset, GLsizeiptr length) \
	...
	GLE(GLboolean,				glUnmapBufferARB,			GLenum target) \
...
bool gl_lite_init()
{
    ...
    #define GLE(ret, name, ...)																		\
            ...
            if (!name) {																			\
                printf("Function " #name " couldn't be loaded from opengl32.dll\n");	\
            }
        CR_GL_FUNC_LIST
        CR_GL_FUNC_LIST_WIN32
    #undef GLE
